...
def loadBioNLPData(taskName):
	...
	taskOptions['2016-BB3-event-train'] = (files,expectedDir)
	# 2016-BB3-event-dev
	...
	taskOptions['2016-BB3-event-dev'] = (files,expectedDir)
	# 2016-BB3-event-test
	...
	taskOptions['2016-BB3-event-test'] = (files,expectedDir)
	...
	taskOptions['2016-SeeDev-binary-train'] = (files,expectedDir)
	...
	taskOptions['2016-SeeDev-binary-dev'] = (files,expectedDir)
	...
	taskOptions['2016-SeeDev-binary-test'] = (files,expectedDir)
	...
	taskOptions['2016-SeeDev-full-train'] = (files,expectedDir)
	...
	taskOptions['2016-SeeDev-full-dev'] = (files,expectedDir)
	...
	taskOptions['2016-SeeDev-full-test'] = (files,expectedDir)

	assert taskName in taskOptions.keys(), "%s not a valid option in %s" % (taskName, taskOptions.keys())
	filesToDownload,expectedDir = taskOptions[taskName]
