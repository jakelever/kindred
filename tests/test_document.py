...
def test_document_splitIntoSentences():
	...
	expectedTokens0 = "('Erlotinib', 'Erlotinib', 'PROPN', 0, 9),('is', 'be', 'AUX', 10, 12),('an', 'an', 'DET', 13, 15),('EGFR', 'EGFR', 'PROPN', 16, 20),('inhibitor', 'inhibitor', 'NOUN', 21, 30),('.', '.', 'PUNCT', 30, 31)"
	...
	expectedTokens1 = "('Gefitinib', 'Gefitinib', 'PROPN', 0, 9),('is', 'be', 'AUX', 10, 12),('another', 'another', 'DET', 13, 20),('drug', 'drug', 'NOUN', 21, 25),('.', '.', 'PUNCT', 25, 26)"
