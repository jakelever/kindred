...
def test_relation_triple_equals():
	rel1 = kindred.Relation(relationType="causes",entityIDs=[1,2,3],argNames=None)
	rel2 = kindred.Relation(relationType="causes",entityIDs=[1,2,3],argNames=None)
	rel3 = kindred.Relation(relationType="causes",entityIDs=[1,2,3],argNames=["drug","disease","drug"])
	rel4 = kindred.Relation(relationType="causes",entityIDs=[1,2,3],argNames=["drug","disease","drug"])
