...
def test_filterByEntityTypes_validTypes():
	...
	classifier = kindred.RelationClassifier(features=["unigramsBetweenEntities","bigrams","dependencyPathEdges","dependencyPathNearSelected"])
	classifier.train(trainCorpus)
...
def test_filterByEntityTypes_validTypes_multi():
	...
	classifier = kindred.RelationClassifier(useSingleClassifier=False, features=["unigramsBetweenEntities","bigrams","dependencyPathEdges","dependencyPathNearSelected"])
	classifier.train(trainCorpus)
